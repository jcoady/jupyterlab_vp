...
require("script-loader!./vpython_libraries/jquery.min.js");
require("script-loader!./vpython_libraries/jquery-ui.custom.min.js");
require("script-loader!./vpython_libraries/glow.min.js");
require("script-loader!./vpython_libraries/plotly.min.js");
...
function process_binding(event) {
    "use strict";
    event.bind = true;
    process(event);
}
var sliders = {};
function control_handler(obj) {
    "use strict";
    var evt = { idx: obj.idx };
...
var attrs = { 'a': 'pos', 'b': 'up', 'c': 'color', 'd': 'trail_color',
...
var methods = { 'a': 'select', 'b': 'pos', 'c': 'start', 'd': 'stop', 'f': 'clear',
        ...
        switch (obj) {
            ...
            case 'text': {
                if (cfg._cloneid !== undefined) {
                    ...
                    send_compound(obj.canvas['idx'], vec(obj.length, obj.descender, 0), obj.__comp.size, obj.up);
                }
                break;
            }
            case 'local_light': {
